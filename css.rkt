...
(provide *css* *color-bg*) ; color-bg used for theme color meta
...
#;#;
(define color-link color-fg)
(define color-rule color-dark)

(define font         'ui-monospace)
(define font-norm    400)
(define font-bold    600)
  ...
  (css-expr->css
    (css-expr
      ...
      [nav #:display flex
           ...
           #:border-bottom (,border-thickness solid ,color-dark)]
      ...
      [header #:border-bottom (,border-thickness solid ,color-dark)
      ...
      [|.buttons| #:display flex
                  ...
                  #:border-top (,border-thickness solid ,color-dark)]
